/* scanner.c generated by valac 0.20.1.19-a6516, the Vala compiler
...
static void ____lambda14__caribou_scanner_unconfigure_switch_func (gpointer self);
...
static void ____lambda15_ (Block1Data* _data1_);
static void _____lambda15__caribou_scanner_unconfigure_switch_func (gpointer self);
...
static void caribou_scanner_configure_switch (CaribouScanner* self) {
	...
	if (_tmp8_) {
		...
		self->priv->unconfigure_switch_func_target = NULL;
		self->priv->unconfigure_switch_func_target_destroy_notify = NULL;
		self->priv->unconfigure_switch_func = ____lambda14__caribou_scanner_unconfigure_switch_func;
		...
		if (_tmp19_) {
			...
			self->priv->unconfigure_switch_func_target = NULL;
			self->priv->unconfigure_switch_func_target_destroy_notify = NULL;
			self->priv->unconfigure_switch_func = _____lambda15__caribou_scanner_unconfigure_switch_func;
