/* level-model.c generated by valac 0.20.1.19-a6516, the Vala compiler
...
static void __lambda9_ (CaribouLevelModel* self, CaribouKeyModel* k);
...
static void __lambda10_ (CaribouLevelModel* self, CaribouKeyModel* k);
...
static void _caribou_level_model_on_key_clicked_caribou_ikeyboard_object_key_clicked (CaribouIKeyboardObject* _sender, CaribouKeyModel* key, gpointer self) {
	caribou_level_model_on_key_clicked (self, key);
}
...
void caribou_level_model_add_row (CaribouLevelModel* self, CaribouRowModel* row) {
	CaribouRowModel* _tmp0_;
	CaribouRowModel* _tmp1_;
	CaribouRowModel* _tmp2_;
	GeeArrayList* _tmp3_;
	CaribouRowModel* _tmp4_;
...
static void caribou_level_model_class_init (CaribouLevelModelClass * klass) {
	...
	CARIBOU_SCANNABLE_GROUP_CLASS (klass)->get_scan_children = caribou_level_model_real_get_scan_children;
