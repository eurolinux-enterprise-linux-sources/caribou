/* ikeyboard-object.c generated by valac 0.20.1.19-a6516, the Vala compiler
	...
	_tmp2_ = caribou_ikeyboard_object_get_children (self, &_tmp1_);
	{
		...
		for (obj_it = 0; obj_it < _tmp1_; obj_it = obj_it + 1) {
			...
			obj = _tmp3_;
			{
				...
				CaribouIKeyboardObject* _tmp4_;
				gint _tmp5_ = 0;
				CaribouKeyModel** _tmp6_ = NULL;
				gint obj_keys_length1;
				gint _obj_keys_size_;
