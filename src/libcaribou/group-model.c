/* group-model.c generated by valac 0.20.1.19-a6516, the Vala compiler
...
static void ___lambda11__caribou_ikeyboard_object_key_clicked (CaribouIKeyboardObject* _sender, CaribouKeyModel* key, gpointer self);
static void __lambda12_ (CaribouGroupModel* self, CaribouKeyModel* k);
static void ___lambda12__caribou_ikeyboard_object_key_pressed (CaribouIKeyboardObject* _sender, CaribouKeyModel* key, gpointer self);
static void __lambda13_ (CaribouGroupModel* self, CaribouKeyModel* k);
static void ___lambda13__caribou_ikeyboard_object_key_released (CaribouIKeyboardObject* _sender, CaribouKeyModel* key, gpointer self);
...
void caribou_group_model_add_level (CaribouGroupModel* self, const gchar* lname, CaribouLevelModel* level) {
	...
	_tmp4_ = level;
	g_signal_connect_object ((CaribouIKeyboardObject*) _tmp4_, "key-clicked", (GCallback) ___lambda11__caribou_ikeyboard_object_key_clicked, self, 0);
	_tmp5_ = level;
	g_signal_connect_object ((CaribouIKeyboardObject*) _tmp5_, "key-pressed", (GCallback) ___lambda12__caribou_ikeyboard_object_key_pressed, self, 0);
	_tmp6_ = level;
	g_signal_connect_object ((CaribouIKeyboardObject*) _tmp6_, "key-released", (GCallback) ___lambda13__caribou_ikeyboard_object_key_released, self, 0);
	_tmp7_ = level;
