/* row-model.c generated by valac 0.32.0.49-00a57, the Vala compiler
...
static void ___lambda8__caribou_ikeyboard_object_key_clicked (CaribouIKeyboardObject* _sender, CaribouKeyModel* key, gpointer self);
static void __lambda9_ (CaribouRowModel* self, CaribouKeyModel* k);
static void ___lambda9__caribou_ikeyboard_object_key_pressed (CaribouIKeyboardObject* _sender, CaribouKeyModel* key, gpointer self);
static void __lambda10_ (CaribouRowModel* self, CaribouKeyModel* k);
static void ___lambda10__caribou_ikeyboard_object_key_released (CaribouIKeyboardObject* _sender, CaribouKeyModel* key, gpointer self);
...
static void ___lambda8__caribou_ikeyboard_object_key_clicked (CaribouIKeyboardObject* _sender, CaribouKeyModel* key, gpointer self) {
	__lambda8_ ((CaribouRowModel*) self, key);
}
...
static void ___lambda9__caribou_ikeyboard_object_key_pressed (CaribouIKeyboardObject* _sender, CaribouKeyModel* key, gpointer self) {
	__lambda9_ ((CaribouRowModel*) self, key);
}
...
static void ___lambda10__caribou_ikeyboard_object_key_released (CaribouIKeyboardObject* _sender, CaribouKeyModel* key, gpointer self) {
	__lambda10_ ((CaribouRowModel*) self, key);
}
...
void caribou_row_model_add_column (CaribouRowModel* self, CaribouColumnModel* column) {
	...
	CaribouColumnModel* _tmp4_ = NULL;
	g_return_if_fail (self != NULL);
	g_return_if_fail (column != NULL);
	_tmp0_ = column;
	g_signal_connect_object ((CaribouIKeyboardObject*) _tmp0_, "key-clicked", (GCallback) ___lambda8__caribou_ikeyboard_object_key_clicked, self, 0);
	_tmp1_ = column;
	g_signal_connect_object ((CaribouIKeyboardObject*) _tmp1_, "key-pressed", (GCallback) ___lambda9__caribou_ikeyboard_object_key_pressed, self, 0);
	_tmp2_ = column;
	g_signal_connect_object ((CaribouIKeyboardObject*) _tmp2_, "key-released", (GCallback) ___lambda10__caribou_ikeyboard_object_key_released, self, 0);
...
CaribouColumnModel** caribou_row_model_get_columns (CaribouRowModel* self, int* result_length1) {
	...
	CaribouColumnModel** _tmp3_ = NULL;
...
static void caribou_row_model_class_init (CaribouRowModelClass * klass) {
	...
	((CaribouScannableGroupClass *) klass)->get_scan_children = caribou_row_model_real_get_scan_children;
