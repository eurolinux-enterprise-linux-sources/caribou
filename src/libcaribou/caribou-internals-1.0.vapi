/* caribou-internals-1.0.vapi generated by valac 0.20.1.19-a6516, do not modify. */

namespace Caribou {
	[CCode (cheader_filename = "caribou-internals.h")]
	public class XAdapter : GLib.Object {
		public delegate void KeyButtonCallback (uint keybuttoncode, bool pressed);
		public static Caribou.XAdapter get_default ();
		...
		public uint get_current_group (out string group_name, out string variant_name);
		public void get_groups (out string[] group_names, out string[] variant_names);
		public void register_key_func (uint keyval, Caribou.XAdapter.KeyButtonCallback? func);
		public void register_button_func (uint button, Caribou.XAdapter.KeyButtonCallback? func);
		public XAdapter ();
