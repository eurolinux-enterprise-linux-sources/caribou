/* keyboard-service.c generated by valac 0.20.1.19-a6516, the Vala compiler
...
static void _dbus_caribou_keyboard_service_set_cursor_location (CaribouKeyboardService* self, GVariant* parameters, GDBusMethodInvocation* invocation);
static void _dbus_caribou_keyboard_service_set_entry_location (CaribouKeyboardService* self, GVariant* parameters, GDBusMethodInvocation* invocation);
static void _dbus_caribou_keyboard_service_show (CaribouKeyboardService* self, GVariant* parameters, GDBusMethodInvocation* invocation);
static void _dbus_caribou_keyboard_service_hide (CaribouKeyboardService* self, GVariant* parameters, GDBusMethodInvocation* invocation);
...
static void _caribou_keyboard_service_on_bus_acquired_gbus_acquired_callback (GDBusConnection* connection, const gchar* name, gpointer self) {
	caribou_keyboard_service_on_bus_acquired (self, connection);
}


static void _caribou_keyboard_service_on_impl_name_acquired_gbus_name_acquired_callback (GDBusConnection* connection, const gchar* name, gpointer self) {
	caribou_keyboard_service_on_impl_name_acquired (self, connection, name);
}


static void _caribou_keyboard_service_on_impl_name_lost_gbus_name_lost_callback (GDBusConnection* connection, const gchar* name, gpointer self) {
	caribou_keyboard_service_on_impl_name_lost (self, connection, name);
}
...
static void _caribou_keyboard_service_on_generic_name_acquired_gbus_name_acquired_callback (GDBusConnection* connection, const gchar* name, gpointer self) {
	caribou_keyboard_service_on_generic_name_acquired (self, connection, name);
}


static void _caribou_keyboard_service_on_name_lost_gbus_name_lost_callback (GDBusConnection* connection, const gchar* name, gpointer self) {
	caribou_keyboard_service_on_name_lost (self, connection, name);
}
...
static void caribou_keyboard_service_class_init (CaribouKeyboardServiceClass * klass) {
	...
	CARIBOU_KEYBOARD_SERVICE_CLASS (klass)->set_cursor_location = caribou_keyboard_service_real_set_cursor_location;
	CARIBOU_KEYBOARD_SERVICE_CLASS (klass)->set_entry_location = caribou_keyboard_service_real_set_entry_location;
	CARIBOU_KEYBOARD_SERVICE_CLASS (klass)->show = caribou_keyboard_service_real_show;
	CARIBOU_KEYBOARD_SERVICE_CLASS (klass)->hide = caribou_keyboard_service_real_hide;
	CARIBOU_KEYBOARD_SERVICE_CLASS (klass)->name_lost = caribou_keyboard_service_real_name_lost;
}
